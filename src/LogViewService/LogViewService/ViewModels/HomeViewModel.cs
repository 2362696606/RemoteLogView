...
using LogViewService.CustomControl;
using LogViewService.Models.EventArgs;
using LogViewService.Service.Abstract.Interface;
...
/// </summary>
/// <remarks>
/// HomeViewModel 负责处理日志查看的核心逻辑，包括接收、过滤及清理日志等操作。它通过绑定与用户界面相连接，同时为日志管理提供数据支持。
/// </remarks>
public class HomeViewModel : ObservableObject
{
    ...
    /// </remarks>
    public AsyncRelayCommand RefreshCommand => new AsyncRelayCommand(DoRefresh);
    ...
    /// </remarks>
    public AsyncRelayCommand ClearCommand => new AsyncRelayCommand(DoClear);
